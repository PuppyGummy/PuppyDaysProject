...
public class MenuSettings : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else if (EventSystem.current.currentSelectedGameObject == sfxSetting.gameObject)
        {
            SFXSlider.Select();
        }
        else if (EventSystem.current.currentSelectedGameObject == bgmSetting.gameObject)
        {
            musicSliderelect();
        }
    }
