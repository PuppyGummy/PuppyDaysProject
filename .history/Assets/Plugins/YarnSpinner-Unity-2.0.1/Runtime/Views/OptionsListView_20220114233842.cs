...
namespace Yarn.Unity
{
    public class OptionsListView : DialogueViewBase
    {
        ...
        [SerializeField] Sprite arrow = null;
        ...
        {
            Debug.Log("RunOptions method invoked");
            ...
            for (int i = 0; i < dialogueOptions.Length; i++)
            {
                ...
                {
                    optionView.Select();
                    // EventSystem.current.firstSelectedGameObject = optionView.gameObject;
                    optionView.SetSprite(arrow);
                    optionView.texttext.color = Color.black;
                }
